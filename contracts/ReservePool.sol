...
contract ReservePool is Tokenpay{
    ...
    function withdraw() external {
        ...
        // tokenpay.approve(address(this), tokenBalance); 
        // tokenpay.burnFrom(msg.sender, tokenBalance);
    ...
    function stake() external{
        ...
        // tokenpay.approve(address(this), tokenBalance);
        // tokenpay.transferFrom(msg.sender, address(staking), tokenBalance );
